...
static const float temperatureOptions[5]  = 	{0, 25, 50, 75, 100};
static const float heightOptions[5]       =	{-30, 0, 15, 35, 55};
static const float humidityOptions[2]    = 	{25, 50};

static const int numTemperatureOptions = 5;
static const int numHeightOptions = 5;
static const int numHumidityOptions = 2;

static const string biomeGrid[numTemperatureOptions + 1][numHeightOptions + 1][numHumidityOptions + 1] = {
    {
        /* temp < 0: */
